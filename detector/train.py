...
import test  # 每个epoch后计算mAP
from detector.models import *
from detector.utils.datasets import *
from detector.utils.utils import *

mixed_precision = True
try:  # 多精度训练 https://github.com/NVIDIA/apex
    from apex import amp
except:
    mixed_precision = False  # 没有apex

wdir = 'weights' + os.sep  # 权重文件路径
last = wdir + 'last.pt'
best = wdir + 'best.pt'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/person/person.data', help='*.data path')
    parser.add_argument('--multi-scale', action='store_true', help='adjust (67% - 150%) img_size every 10 batches')
    parser.add_argument('--img-size', nargs='+', type=int, default=[160], help='train and test image-sizes')
